...
function App() {
  ...
  const [page, setPage] = useState("annotator");
  ...
  const navigatePage = (nextPage) => {
    setPage(nextPage);
    window.location.hash = nextPage === "guide" ? "guide" : "annotator";
  };

  useEffect(() => {
    const syncPageFromHash = () => {
      setPage(window.location.hash === "#guide" ? "guide" : "annotator");
    };
    syncPageFromHash();
          ...
          <Box sx={{ position: "relative", textAlign: "center", mb: 1.5 }}>
            ...
            <Box sx={{ mt: 1.5, display: "flex", justifyContent: "center", gap: 1 }}>
              <Button
                variant="text"
                size="medium"
                onClick={() => navigatePage(page === "guide" ? "annotator" : "guide")}
                aria-label={page === "guide" ? "Main" : "Guide"}
                sx={{
                  px: 2,
                  py: 0.6,
                  width: 82,
              ...
              >
                {page === "guide" ? <HomeIcon sx={{ fontSize: 28 }} /> : "Guide"}
              </Button>
            </Box>
          </Box>
